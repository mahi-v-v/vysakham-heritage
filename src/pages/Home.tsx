...
import heroImageDay from "../assets/homestay-day.jpg";
import heroImageNight from "../assets/homestay-night.jpg";
    ...
    <div className="transition-colors duration-300">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${isDark ? heroImageNight : heroImageDay})`,
          }}
        />
